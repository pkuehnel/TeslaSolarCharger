...
public class Constants : IConstants
{
    ...
    public string ChargeStartRequestUrl => "command/charge_start";
    public string ChargeStopRequestUrl => "command/charge_stop";
    public string SetChargingAmpsRequestUrl => "command/set_charging_amps";
    public string SetScheduledChargingRequestUrl => "command/set_scheduled_charging";
    public string SetChargeLimitRequestUrl => "command/set_charge_limit";
    public string SetSentryModeRequestUrl => "command/set_sentry_mode";
    public string FlashHeadlightsRequestUrl => "command/flash_lights";
    public string WakeUpRequestUrl => "wake_up";
    public string VehicleRequestUrl => "";
    public string VehicleDataRequestUrl => $"vehicle_data?endpoints={Uri.EscapeDataString("drive_state;location_data;vehicle_state;charge_state;climate_state")}";
