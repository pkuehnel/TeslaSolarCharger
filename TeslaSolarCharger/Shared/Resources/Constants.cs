...
public class Constants : IConstants
{
    ...
    public string ChargeStartRequestUrl => "ChargeStart";
    public string ChargeStopRequestUrl => "ChargeStop";
    public string SetChargingAmpsRequestUrl => "SetChargingAmps";
    public string SetChargeLimitRequestUrl => "SetChargeLimit";
    ...
    public string EmailConfigurationKey => "UserEmailAddress";
    public string BackendPasswordConfigurationKey => "BackendPassword";
