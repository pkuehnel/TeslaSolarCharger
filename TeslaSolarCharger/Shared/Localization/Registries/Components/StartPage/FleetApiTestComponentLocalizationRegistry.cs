...
public class FleetApiTestComponentLocalizationRegistry : TextLocalizationRegistry<FleetApiTestComponentLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.FleetApiTestLoadStateError,
        ...
        Register(TranslationKeys.FleetApiTestInProgressMessage,
        ...
        Register(TranslationKeys.FleetApiTestSuccessMessage,
        ...
        Register(TranslationKeys.FleetApiTestFailureMessage,
        ...
        Register(TranslationKeys.FleetApiTestWakeCarNotePrefix,
        ...
        Register(TranslationKeys.FleetApiTestRetestLinkText,
        ...
        Register(TranslationKeys.FleetApiTestKeyCheckInstructionsPrefix,
        ...
        Register(TranslationKeys.FleetApiTestNotTestedPromptSuffix,
        ...
        Register(TranslationKeys.FleetApiTestNotRegisteredPrefix,
        ...
        Register(TranslationKeys.FleetApiTestNotRegisteredSuffix,
        ...
        Register(TranslationKeys.FleetApiTestSelectCarNote,
        ...
        Register(TranslationKeys.FleetApiTestRegisteredNotTestedPrefix,
