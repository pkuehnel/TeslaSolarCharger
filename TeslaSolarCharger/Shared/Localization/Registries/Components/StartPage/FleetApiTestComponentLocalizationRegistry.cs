...
public class FleetApiTestComponentLocalizationRegistry : TextLocalizationRegistry<FleetApiTestComponentLocalizationRegistry>
{
    protected override void Configure()
    {
        ...
        Register(TranslationKeys.FleetApiTestFailedHint,
            ...
            new TextLocalizationTranslation(LanguageCodes.German, "Hinweis: Für den Test muss das Fahrzeug wach sein. Wenn das Fahrzeug nicht wach war, wecken Sie es auf und"));
        ...
        Register(TranslationKeys.FleetApiTestKeyCheckHint,
            ...
            new TextLocalizationTranslation(LanguageCodes.German, "Wenn es immer noch nicht funktioniert, gehen Sie zu Ihrem Fahrzeug und überprüfen Sie unter Steuerung -> Verriegelungen, ob ein Schlüssel namens \"solar4car.com\" vorhanden ist. Falls nicht, versuchen Sie, den Schlüssel erneut hinzuzufügen, indem Sie auf klicken"));
        ...
        Register(TranslationKeys.FleetApiTestRegisterCarNote,
            ...
            new TextLocalizationTranslation(LanguageCodes.German, "Hinweis: Es ist nicht möglich, das richtige Fahrzeug auszuwählen. Um das richtige Fahrzeug zu registrieren, müssen Sie das Fahrzeug in der Tesla-App auswählen, bevor Sie auf die Schaltfläche klicken."));
