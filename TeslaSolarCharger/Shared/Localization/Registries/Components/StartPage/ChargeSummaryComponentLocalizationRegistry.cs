...
public class ChargeSummaryComponentLocalizationRegistry : TextLocalizationRegistry<ChargeSummaryComponentLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.TotalChargedSolarEnergy,
        ...
        Register(TranslationKeys.TotalChargedHomeBatteryEnergy,
        ...
        Register(TranslationKeys.TotalChargedGridEnergy,
        ...
        Register(TranslationKeys.TotalChargeCostNoteTheCharge,
        ...
        Register(TranslationKeys.Key0PerKwh,
