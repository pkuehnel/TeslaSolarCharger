...
public class NotChargingAtExpectedPowerReasonsComponentLocalizationRegistry : TextLocalizationRegistry<NotChargingAtExpectedPowerReasonsComponentLocalizationRegistry>
{
    ...
    {
        Register("{0} reason(s) why loadpoint charges with different power than you might expect",
            new TextLocalizationTranslation(LanguageCodes.English, "{0} reason(s) why loadpoint charges with different power than you might expect"),
