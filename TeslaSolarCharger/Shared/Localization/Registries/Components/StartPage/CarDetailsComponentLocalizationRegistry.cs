...
public class CarDetailsComponentLocalizationRegistry : TextLocalizationRegistry<CarDetailsComponentLocalizationRegistry>
{
    protected override void Configure()
    {
        ...
        Register(TranslationKeys.CarDetailsChargeModeHelp,
            new TextLocalizationTranslation(LanguageCodes.English, "Help with charge modes"),
            new TextLocalizationTranslation(LanguageCodes.German, "Hilfe zu den Lademodi"));
