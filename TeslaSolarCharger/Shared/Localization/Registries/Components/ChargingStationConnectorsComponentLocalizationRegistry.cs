...
public class ChargingStationConnectorsComponentLocalizationRegistry : TextLocalizationRegistry<ChargingStationConnectorsComponentLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.ChargingStationConnectorsCurrentBelowSixWarningTitle,
        ...
        Register(TranslationKeys.ChargingStationConnectorsCurrentBelowSixWarningDescription,
