...
public class ChargingStationsPageLocalizationRegistry : TextLocalizationRegistry<ChargingStationsPageLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.ChargingStationsPageTitle,
        ...
        Register(TranslationKeys.ChargingStationsPageHowToConnectTitle,
        ...
        Register(TranslationKeys.ChargingStationsPageAutoAddInfo,
        ...
        Register(TranslationKeys.ChargingStationsPageOcppUrlInstruction,
        ...
        Register(TranslationKeys.ChargingStationsPageOcppUrlNote,
        ...
        Register(TranslationKeys.ChargingStationsPageOcppUrlExample,
        ...
        Register(TranslationKeys.ChargingStationsPageNoStationsFound,
        ...
        Register(TranslationKeys.ChargingStationsPageConnectedViaOcppStatus,
        ...
        Register(TranslationKeys.ChargingStationsPageNotConnectedViaOcppStatus,
