...
public class BaseConfigurationPageLocalizationRegistry : TextLocalizationRegistry<BaseConfigurationPageLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.BaseConfigurationGeneralLabel,
        ...
        Register(TranslationKeys.BaseConfigurationTeslaMateLabel,
        ...
        Register(TranslationKeys.BaseConfigurationHomeGeofenceHeading,
        ...
        Register(TranslationKeys.LocationUpdateSnackbarText,
        ...
        Register(TranslationKeys.BaseConfigurationTelegramLabel,
        ...
        Register(TranslationKeys.BaseConfigurationTelegramSetupLink,
        ...
        Register(TranslationKeys.BaseConfigurationTelegramNote,
        ...
        Register(TranslationKeys.BaseConfigurationSendTestMessage,
        ...
        Register(TranslationKeys.BaseConfigurationSaveBeforeTesting,
        ...
        Register(TranslationKeys.BaseConfigurationAdvancedSettings,
