...
public class BaseConfigurationPageLocalizationRegistry : TextLocalizationRegistry<BaseConfigurationPageLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.BaseConfigurationPageGeneralSectionTitle,
        ...
        Register(TranslationKeys.BaseConfigurationPageTeslaMateSectionTitle,
        ...
        Register(TranslationKeys.BaseConfigurationPageHomeGeofenceTitle,
        ...
        Register(TranslationKeys.BaseConfigurationPageHomeGeofenceMapInstructions,
        ...
        Register(TranslationKeys.BaseConfigurationPageTelegramSectionTitle,
        ...
        Register(TranslationKeys.BaseConfigurationPageTelegramSetupTitle,
        ...
        Register(TranslationKeys.BaseConfigurationPageTelegramNote,
        ...
        Register(TranslationKeys.BaseConfigurationPageTelegramSendTestButton,
        ...
        Register(TranslationKeys.BaseConfigurationPageSaveBeforeTestingWarning,
        ...
        Register(TranslationKeys.BaseConfigurationPageAdvancedSettingsDescription,
        ...
        Register(TranslationKeys.BaseConfigurationPageIntervalWarning,
        ...
        Register(TranslationKeys.BaseConfigurationPageSavedNotification,
        ...
        Register(TranslationKeys.BaseConfigurationPageResultError,
