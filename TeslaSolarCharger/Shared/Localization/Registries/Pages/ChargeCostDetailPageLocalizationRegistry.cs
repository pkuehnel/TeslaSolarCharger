...
public class ChargeCostDetailPageLocalizationRegistry : TextLocalizationRegistry<ChargeCostDetailPageLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.AllChargeCosts,
        ...
        Register(TranslationKeys.Chargepricedetail,
        ...
        Register(TranslationKeys.SolarPrice,
        ...
        Register(TranslationKeys.EnergyProvider,
        ...
        Register(TranslationKeys.FixedPriceOrSpotPrice,
        ...
        Register(TranslationKeys.TimeBasedPrices,
        ...
        Register(TranslationKeys.BasePriceSpotPriceWillBe,
        ...
        Register(TranslationKeys.GridPrice,
        ...
        Register(TranslationKeys.YouCanSpecifyTimesWithSpecial,
        ...
        Register(TranslationKeys.SpotPriceRegion,
        ...
        Register(TranslationKeys.UseSpotPrices,
        ...
        Register(TranslationKeys.EnableThisIfYouAreUsing,
        ...
        Register(TranslationKeys.AdditionalCostsToSpotprice,
        ...
        Register(TranslationKeys.SurchargeToSpotPriceEG,
        ...
        Register(TranslationKeys.UpdatingChargePricesCanTakeA,
        ...
        Register(TranslationKeys.ChargePriceIsNullAndCan,
