...
public class HomePageLocalizationRegistry : TextLocalizationRegistry<HomePageLocalizationRegistry>
{
    protected override void Configure()
    {
        ...
        Register(TranslationKeys.HomePageNoCarsInfoPrefix,
        ...
        Register(TranslationKeys.HomePageAddCarLinkText,
        ...
        Register(TranslationKeys.HomePageAddChargingStationSuffix,
        ...
        Register(TranslationKeys.HomePageReferralCodePrompt,
        ...
        Register(TranslationKeys.HomePageDonateWithPaypalButtonAlt,
