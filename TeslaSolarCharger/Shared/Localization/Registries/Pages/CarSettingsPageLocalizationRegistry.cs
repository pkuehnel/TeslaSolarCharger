...
public class CarSettingsPageLocalizationRegistry : TextLocalizationRegistry<CarSettingsPageLocalizationRegistry>
{
    ...
    {
        Register(TranslationKeys.CarSettingsPageTitle,
        ...
        Register(TranslationKeys.CarSettingsPageCreateTokenButton,
        ...
        Register(TranslationKeys.CarSettingsPageCloudConnectionSectionTitle,
        ...
        Register(TranslationKeys.CarSettingsPageRestartToAddCarsHint,
        ...
        Register(TranslationKeys.CarSettingsPageRestartIfCarsMissingHint,
        ...
        Register(TranslationKeys.CarSettingsPageAddNonTeslaCarButton,
        ...
        Register(TranslationKeys.CarSettingsPageAddCarButton,
        ...
        Register(TranslationKeys.CarSettingsPageInvalidFleetApiTokenError,
        ...
        Register(TranslationKeys.CarSettingsPageGenerateFleetApiTokenSuffix,
        ...
        Register(TranslationKeys.CarSettingsPageCurrentBelowSixAmpWarningTitle,
        ...
        Register(TranslationKeys.CarSettingsPageCurrentBelowSixAmpWarningDescription,
        ...
        Register(TranslationKeys.CarSettingsPageGpsLocationDetectionTitle,
        ...
        Register(TranslationKeys.CarSettingsPageGpsLocationDetectionDescriptionPrefix,
        ...
        Register(TranslationKeys.CarSettingsPageGpsLocationDetectionDescriptionSuffix,
            new TextLocalizationTranslation(LanguageCodes.English, "."),
            new TextLocalizationTranslation(LanguageCodes.German, "."));

        Register(TranslationKeys.CarSettingsPageTeslaNavigationHomeTitle,
        ...
        Register(TranslationKeys.CarSettingsPageTeslaNavigationHomeDescription,
        ...
        Register(TranslationKeys.CarSettingsPageTeslaNavigationWorkTitle,
        ...
        Register(TranslationKeys.CarSettingsPageTeslaNavigationWorkDescription,
        ...
        Register(TranslationKeys.CarSettingsPageTeslaNavigationFavoriteTitle,
        ...
        Register(TranslationKeys.CarSettingsPageTeslaNavigationFavoriteDescription,
        ...
        Register(TranslationKeys.CarSettingsPageHomeDetectionViaLabel,
        ...
        Register(TranslationKeys.CarSettingsPageBlePairingSectionTitle,
        ...
        Register(TranslationKeys.CarSettingsPageBleRateLimitExplanationPrefix,
        ...
        Register(TranslationKeys.CarSettingsPageBleRateLimitExplanationSuffix,
        ...
        Register(TranslationKeys.CarSettingsPageBlePairingNote,
        ...
        Register(TranslationKeys.CarSettingsPageBlePairButton,
        ...
        Register(TranslationKeys.CarSettingsPageBleTestAccessButton,
        ...
        Register(TranslationKeys.CarSettingsPageBleTestAccessPrerequisite,
        ...
        Register(TranslationKeys.CarSettingsPageBleSetToSevenAmpTestDescription,
        ...
        Register(TranslationKeys.CarSettingsPageBleSetToSevenAmpButton,
        ...
        Register(TranslationKeys.CarSettingsPageBleTestWakeupButton,
        ...
        Register(TranslationKeys.CarSettingsPageBleTestWakeupDescription,
        ...
        Register(TranslationKeys.CarSettingsPageBleWakeupButton,
        ...
        Register(TranslationKeys.CarSettingsPageBleDeserializeError,
        ...
        Register(TranslationKeys.CarSettingsPageBleAccessSuccessMessage,
        ...
        Register(TranslationKeys.CarSettingsPageBleWakeCallAcceptedMessage,
