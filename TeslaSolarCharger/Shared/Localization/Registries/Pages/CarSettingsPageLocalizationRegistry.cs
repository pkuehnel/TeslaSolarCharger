...
public class CarSettingsPageLocalizationRegistry : TextLocalizationRegistry<CarSettingsPageLocalizationRegistry>
{
    protected override void Configure()
    {
        ...
        Register(", Generate a Tesla Fleet API Token and restart TSC to see cars here.",
        ...
        Register("Restart TSC to add new cars",
        ...
        Register("If you do not see all cars here that are available in your Tesla account, restart TSC.",
        ...
        Register("The Type 2 standard states that the minimum current below 6A is not allowed. Setting this below 6A might result in unexpected behaviour like the car not charging at all.",
        ...
        Register("GPS Location used for home detection",
        ...
        Register("TSC will manage charging if the car's GPS Location is within the configured Home Geofence set in ",
        ...
        Register("Tesla navigation Home used for home detection",
        ...
        Register("TSC will manage charging if the car is at the home location set in the Tesla navigation system. Note: Different driver profiles with different home addresses might mess this up. Make sure that the last driver has the correct home address set in the Tesla navigation system.",
        ...
        Register("Tesla navigation Work used for home detection",
        ...
        Register("TSC will manage charging if the car is at the work location set in the Tesla navigation system. Note: Different driver profiles with different work addresses might mess this up. Make sure that the last driver has the correct work address set in the Tesla navigation system.",
        ...
        Register("Tesla navigation Favorite used for home detection",
        ...
        Register("To come around rate limits TSC can use BLE instead of the Fleet API. This requires ",
        ...
        Register("Before you can test BLE access you must pair the car with TSC. This includes placing the card on your center console and confirming the new \"phone key\" on the car's screen.",
        ...
        Register("After clicking the test button the car 's current should be set to 7A. Note: The car needs to be awake for this test.",
        ...
        Register("After this test the car should wake up.",
        ...
        Register("Could not deserialize message from TSC.",
        ...
        Register("Ble access seems to work. Please double check if the charge current was set to 7A. Note: As TSC starts using BLE as soon as it is working you might see the 7A only for a short time as TSC changes it every 30 seconds by default.",
        ...
        Register("The car accepted the wake call.",
