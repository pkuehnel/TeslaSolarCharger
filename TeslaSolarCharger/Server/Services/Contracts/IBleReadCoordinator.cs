...
/// <summary>
/// Coordinates BLE data reads so a single car is never read via BLE from two places at once (e.g. the regular
/// charging cycle read and the delayed post command read hitting the same BLE container). Registered as a singleton
