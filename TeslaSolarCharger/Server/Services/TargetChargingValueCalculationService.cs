...
using TeslaSolarCharger.Shared.Localization.Keys;
...
public class TargetChargingValueCalculationService : ITargetChargingValueCalculationService
{
        ...
        CancellationToken cancellationToken)
    {
                     ...
                     .OrderBy(x => x.LoadPoint.ChargingPriority))
        {
            ...
            {
                _notChargingWithExpectedPowerReasonHelper.AddLoadPointSpecificReason(loadPoint.LoadPoint.CarId, loadPoint.LoadPoint.ChargingConnectorId, new DtoNotChargingWithExpectedPowerReason(NotChargingWithExpectedPowerReasonKeys.CarIsFullyCharged));
            }
