...
public class ChargingServiceV2Tests : TestBase
{
    ...
    public async Task SetNewChargingValues_FullFlow_WithSchedules_AndTargetValues()
    {
        ...
        Mock.Mock<IChargingScheduleService>().Setup(s => s.GenerateChargingSchedulesForLoadPoint(It.IsAny<DtoLoadPointOverview>(), It.IsAny<List<DtoTimeZonedChargingTarget>>(), It.IsAny<Dictionary<DateTimeOffset, int>>(), It.IsAny<DateTimeOffset>(), It.IsAny<List<DtoChargingSchedule>>(), It.IsAny<CancellationToken>()))
